...
import 'package:faay/screens/home/home_screen.dart';
...
import 'package:faay/widgets/titled_drop_down.dart';
...
class _SignUpScreenState extends State<SignUpScreen> {
                ...
                children: [
                  ...
                  PrimaryButton(
                    ...
                    onTap: () {
                      ...
                      registerWithEmailAndPassword(firstname, lastName, gender, email, password);
                    },
  ...
  Future<void> registerWithEmailAndPassword(
    ...
    try {
      ...
      final username = name.split('').map((e) => e.toLowerCase()).join().replaceAll(" ", "");
