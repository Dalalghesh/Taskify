              ...
              InkWell(
                ...
                child: Row(
                  ...
                  Container(
                    ...
                    child: IconButton(
                      onPressed: (){
                        Navigator.push(context, MaterialPageRoute(builder: (context)=> SendInvitation(list: (provider.list[index].list), category:  widget.category, listId: provider.list[index].docId,)));
                      },
