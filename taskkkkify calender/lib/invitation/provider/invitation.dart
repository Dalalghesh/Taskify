...
class InvitaitonProvider with ChangeNotifier {
  ...
  Future<void> sendInvitation(String email, String category, String list, String listId) async {
    ...
    final InvitationModel invitationModel =
        InvitationModel(recivereEmail: email, senderEmail: currentUserEmail, status: 'pending', category: category, list: list, listId: listId);
    _firebaseFirestore
