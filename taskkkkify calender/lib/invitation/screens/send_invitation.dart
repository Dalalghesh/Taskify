...
class SendInvitation extends StatefulWidget {
  ...
  const SendInvitation({Key? key, required this.list, required this.category, required this.listId}) : super(key: key);
        ...
        child: ListView(
          children: [
            ...
            const SizedBox(
             ...
             SendInvitationForm(
              category: widget.category, list: widget.list, listId: widget.listId
            )
          ],
        ),
      ),
