...
class _TaskDetailState extends State<TaskDetail> {
                    ...
                    child: Center(
                        child: myTask.showSubTasks
                            ? TextFormField(
                                ...
                                decoration: InputDecoration(
                                    errorText: subTaskController.text.length >
                                            15
                                        ? "You can’t enter more than 15 letters"
                                        : null
                                    // border: InputBorder.none,
                                    ),
                              )
                ...
                Row(
                  children: [
                    ...
                    addNewSubTask
                        ? GestureDetector(
                            onTap: () async {
                              if (subTaskController.text.length > 2 &&
                                  subTaskController.text.length < 15) {
                            ...
                            child: myTask.showSubTasks
                                ? Container(
                                    ...
                                    width: 100,
                                    decoration: BoxDecoration(
                                        color: subTaskController.text.length <
                                                    3 ||
                    ...
                    ? Container(
                        ...
                        child: Column(
                            ...
                            children: [
                              ...
                              myTask.manage
                                  ? provider.assignedMembers.isEmpty
                                      ? Center(
                                            ...
                                            return Row(
                                              children: [
                                                Checkbox(
                                                    ...
                                                    onChanged: (v) {
                                                      provider
                                                          .updateCheckBoxofAssignedMembers(
                                                              v,
                                                              index,
                                                              provider
                                                                  .assignedMembers[
                                                ...
                                                provider.assignedMembers[index]
                                                            .userId ==
                                                        FirebaseAuth.instance
                                                            .currentUser!.uid
                                                    ? Text(
                                                        '${provider.assignedMembers[index].userName} (Me)',
                                                        style: TextStyle(
                                                            fontSize: 13,
                                                            color:
                                                                Colors.black),
                                  ...
                                  : provider.assignedLoading
                                      ? Center(
                                          child: CircularProgressIndicator(),
                                        )
                                      : provider.assignedMembers.isEmpty ||
                                              (provider.assignedMembers.where(
                                                      (element) =>
                                                          element.value ==
                                                          true)).length <
                                                  1
  ...
  Assign(BuildContext context) {
    ...
    AlertDialog alert = AlertDialog(
      ...
      content:
          Text('Are you sure you want to assign this task to these users?'),
      actions: [
        cancelButton,
        continueButton,
      ],
