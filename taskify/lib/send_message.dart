    ...
    Widget build(BuildContext context) {
      ...
      return Scaffold(
        ...
        appBar: AppBar(
          ...
          centerTitle: true,
          actions: [
            Padding(padding: EdgeInsets.only(top: 10, right: 16),
                             ...
                             // color: Colors.black,
                              ...
                              child: snapshot.data!.docs[index]['type'] ==
                                ...
                                children: [
                                  ...
                                  : snapshot
                                  .data!.docs[index]['message'] == 'uploading' ?
                              snapshot
                                  .data!.docs[index]['type'] == 'file' ?
                              Container(
                                  height: 70,
                                  width:
                                  MediaQuery
